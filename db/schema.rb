...
ActiveRecord::Schema[7.0].define(version: 20_230_910_191_121) do
  create_table 'hajj_and_umrahs', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    t.text 'description', null: false
    t.date 'entry_date', null: false
    t.string 'voucher_no', null: false
    t.decimal 'visa_rate', precision: 12, scale: 2, default: '0.0', null: false
    t.decimal 'makkah_hotel_amount', precision: 12, scale: 2, default: '0.0', null: false
    t.decimal 'madina_hotel_amount', precision: 12, scale: 2, default: '0.0', null: false
    t.datetime 'deleted_at'
    t.bigint 'user_id'
    t.bigint 'party_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['party_id'], name: 'index_hajj_and_umrahs_on_party_id'
    t.index ['user_id'], name: 'index_hajj_and_umrahs_on_user_id'
  end
  ...
  create_table 'tickets', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'deleted_at'
    t.string 'name', null: false
    t.string 'passport_no', null: false
  ...
  add_foreign_key 'hajj_and_umrahs', 'parties'
  add_foreign_key 'hajj_and_umrahs', 'users'
